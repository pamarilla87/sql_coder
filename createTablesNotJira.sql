...
Create Table WorkflowTransitionLog (
  ...
  CONSTRAINT PK_WORKFLOWTRANSITIONLOG PRIMARY KEY (LogID, SourceStepID,DestinationStepID)
);
ALTER TABLE WORKFLOWTRANSITIONLOG ADD CONSTRAINT FK_WFLOWLOG_SOURCE FOREIGN KEY FK_WFLOWLOG_SOURCE (SourceStepID) REFERENCES WORKFLOWSTEP (StepID);
ALTER TABLE WORKFLOWTRANSITIONLOG ADD CONSTRAINT FK_WFLOWLOG_DESTINATION FOREIGN KEY FK_WFLOWLOG_DESTINATION (DestinationStepID) REFERENCES WORKFLOWSTEP (StepID);
